...
// Previously selected topic (if user selected) || Dark Mode Default
const selectedTheme = localStorage.getItem("selected-theme") == null ? "dark" : localStorage.getItem("selected-theme");
const selectedIcon = localStorage.getItem("selected-icon") == null ? "bx-moon" : localStorage.getItem("selected-icon");
